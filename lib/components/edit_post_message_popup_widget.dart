...
class EditPostMessagePopupWidget extends StatefulWidget {
  const EditPostMessagePopupWidget({
    Key? key,
    required this.userPostDocRef,
  }) : super(key: key);

  final DocumentReference? userPostDocRef;

  @override
  _EditPostMessagePopupWidgetState createState() =>
...
class _EditPostMessagePopupWidgetState
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<UserPostsRecord>(
      stream: UserPostsRecord.getDocument(widget.userPostDocRef!),
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      controller: _model.textController ??=
                        ...
                        text: containerUserPostsRecord.message,
                      ),
                      autofocus: true,
                      obscureText: false,
