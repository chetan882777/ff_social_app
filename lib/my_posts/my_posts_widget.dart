                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ToggleIcon(
                                          ...
                                          value: listViewUserPostsRecord.likes
                                        ...
                                        Text(
                                          valueOrDefault<String>(
                                            listViewUserPostsRecord.likes.length
                                                .toString(),
                                            '0',
                                          ),
                                            ...
                                            Padding(
                                              padding: EdgeInsetsDirectional
                                                  .fromSTEB(
                                                      8.0, 0.0, 0.0, 20.0),
                                              child: Text(
                                                listViewUserPostsRecord.message,
                                                style:
